...
-- ═══════════════════════════════════════════════════
-- §10b ランタイムコールバック（ローカル變數渡し）
-- ═══════════════════════════════════════════════════
def testumCallbackumLocale (f : SakuraIO Unit) : SakuraIO Unit := do
  scriptum! \h \s[5] \q[話す, f]

def testumCallbackumLocaleInputbox (f : String → SakuraIO Unit) : SakuraIO Unit := do
  scriptum! \![open, inputbox, f, "名前を入力"]
